...
App({
  ...
  globalData: {
    ...
    lxtel: '',
    weiAccount: '',
    selfHeadUrl: 'https://bm.jiangcdn.com/banma/avatar.jpg',
    friendHeadUrl: 'https://bm.jiangcdn.com/banma/avatar.jpg',
    token: null,
    auth: null,
    userinfo: {},
    certified:0,
