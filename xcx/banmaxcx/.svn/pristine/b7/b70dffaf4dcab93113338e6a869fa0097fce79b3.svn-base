      ...
      success: function (data) {
        ...
        wx.uploadFile({
          ...
          success:function(res){
            ...
            if (_res.code !=0){
              bm.requsetData('/w/user/auth', 'post', { scene: 2, auth_name: name, auth_code: idcard, status:3 }, function (data) {
              ...
              if (_res.data.live_status == 0) {
                if (_res.data.compare_status == 0) {
                  bm.requsetData('/w/user/auth', 'post', { scene: 2, auth_name: name, auth_code: idcard, status: 2 }, function (data) {
